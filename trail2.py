...
# ohist contains numbers of entries in each bin
# oedge contains bin boundaries
...
# Plot the PDF
plt.bar(xdst, ydst, width=0.9*wdst, color='indigo')
...
xhigh = oedge[indx]
plt.bar(xdst[indx:], ydst[indx:], width=0.9*wdst[indx:], color='orange')
